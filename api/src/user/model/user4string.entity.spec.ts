...
describe('User2String entity', () => {
  ...
  describe('User with string property', () => {
    test('Should create user with string', async () => {
      ...
      await Object.assign(new User4stringEntity(), {string: 'TEST', property, parent}).save();
    ...
    test('Should create user with list of properties', async () => {
      ...
      await Object.assign(new User4stringEntity(), {string: 'TEST_1', property: prop1, parent}).save();
      await Object.assign(new User4stringEntity(), {string: 'TEST_2', property: prop2, parent}).save();
      await Object.assign(new User4stringEntity(), {string: 'TEST_3', property: prop3, parent}).save();
    ...
    test('Shouldn`t create user without parent', async () => {
      ...
      const inst = Object.assign(new User4stringEntity(), {string: 'VALUE', property});
    ...
    test('Shouldn`t create user without string', async () => {
      const property = await Object.assign(new PropertyEntity(), {id: 'PARENT'}).save();
      const parent = await Object.assign(new UserEntity(), {login: 'PARENT'}).save();
      const inst = Object.assign(new User4stringEntity(), {parent, property});
