...
describe('User point property entity', () => {
  ...
  describe("User point fields", () => {
    test('Should create property', async () => {
      ...
      const inst = await Object.assign(new User4pointEntity(), {parent, property, point}).save();
    ...
    test('Shouldn`t create without parent', async () => {
      ...
      const inst = Object.assign(new User4pointEntity(), {property, point});
    ...
    test('Shouldn`t create without point', async () => {
      ...
      const inst = Object.assign(new User4pointEntity(), {parent, property});

      await expect(inst.save()).rejects.toThrow('pointId');
    });
  });

  describe("User with point property", () => {
    test('Should create user with value', async () => {
      ...
      await Object.assign(new User4pointEntity(), { property: 'CURRENT_CITY', point: 'LONDON', parent: 1 }).save();
    ...
    test('Should create user with multi value', async () => {
      ...
      await Object.assign(new User4pointEntity(), { property: 'CURRENT_CITY', point: 'LONDON_0', parent: 1 }).save();
      await Object.assign(new User4pointEntity(), { property: 'CURRENT_CITY', point: 'LONDON_3', parent: 1 }).save();
      await Object.assign(new User4pointEntity(), { property: 'CURRENT_CITY', point: 'LONDON_6', parent: 1 }).save();
    ...
    test('Shouldn`t create user with same value and property', async () => {
      ...
      await Object.assign(new User4pointEntity(), { property: 'CURRENT_CITY', point: 'LONDON', parent: 1 }).save();
      const wrong = Object.assign(new User4pointEntity(), {
