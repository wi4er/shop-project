...
describe('User2description entity', () => {
  ...
  describe("User with description property", () => {
    test("Should create user with description", async () => {
      ...
      await Object.assign(new User4descriptionEntity(), { description: "TEST", property, parent }).save();
    ...
    test("Should create user with list of properties", async () => {
      ...
      await Object.assign(new User4descriptionEntity(), { description: "TEST_1", property: prop1, parent }).save();
      await Object.assign(new User4descriptionEntity(), { description: "TEST_2", property: prop2, parent }).save();
      await Object.assign(new User4descriptionEntity(), { description: "TEST_3", property: prop3, parent }).save();
    ...
    test('Shouldn`t create user without parent', async () => {
      ...
      const inst = await Object.assign(new User4descriptionEntity(), { description: 'VALUE', property });
    ...
    test('Shouldn`t create user without string', async () => {
      const property = await Object.assign(new PropertyEntity(), { id: 'PARENT' }).save();
      const parent = await Object.assign(new UserEntity(), { login: 'PARENT' }).save();
      const inst = await Object.assign(new User4descriptionEntity(), { parent, property });
