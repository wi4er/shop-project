...
export class DirectoryService {
  ...
  async insert(input: DirectoryInput): Promise<DirectoryEntity> {
    ...
    await this.manager.transaction(async (trans: EntityManager) => {
      ...
      await new PointInsertOperation(trans).save(created, input);
    });
  ...
  async update(input: DirectoryInput): Promise<DirectoryEntity> {
    await this.manager.transaction(async (trans: EntityManager) => {
      ...
      await new PointUpdateOperation(trans).save(beforeItem, input);
    });
